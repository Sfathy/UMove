<%@ Page Title="" Language="C#" MasterPageFile="~/Shipments/Site.Master" AutoEventWireup="true" CodeBehind="SharedTripBids.aspx.cs" Inherits="UMoveNew.SharedShipment.SharedTripBids" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="container">
        ...
        HeaderText="Ask Question" ClientInstanceName="ASPxPopupControl1" meta:resourcekey="ASPxPopupControl1Resource1" >
                           <ContentCollection>
                               <dx:PopupControlContentControl runat="server">
                               </dx:PopupControlContentControl>
                           </ContentCollection>
    </dx:ASPxPopupControl>
                    <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT dbo.SharedTripQuestions.Question, dbo.Users.Name AS QuestionUser, dbo.SharedTripQuestions.Answer, Users_1.Name AS AnswerUser, dbo.SharedTripQuestions.QuestionTime, dbo.SharedTripQuestions.AnswerTime FROM dbo.SharedTripQuestions LEFT OUTER JOIN dbo.Users AS Users_1 ON dbo.SharedTripQuestions.AnswerUserID = Users_1.ID LEFT OUTER JOIN dbo.Users ON dbo.SharedTripQuestions.QuestionUserID = dbo.Users.ID WHERE (dbo.SharedTripQuestions.TripID = @ID) AND (dbo.SharedTripQuestions.QuestionPuplished = 1)">
                        <SelectParameters>
