...
{
    public partial class SharedTripBids : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int BidID = cb.insertShareBid(b);
            if (BidID > 0)
            {
                Response.Redirect("~/SharedShipment/SharedTripBids.aspx?id=" + Convert.ToInt32(Request.QueryString["id"].ToString()) + "&&alert=success");
            }
        }
        ...
        {
            int id = Convert.ToInt32(Request.QueryString["id"].ToString());
            Response.Redirect("~/SharedShipment/AskQuestion.aspx?id=" + id);
        }
    }
}
