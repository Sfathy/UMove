<%@ Page Title="" Language="C#" MasterPageFile="~/Shipments/Site.Master" AutoEventWireup="true" CodeBehind="TripEdit.aspx.cs" Inherits="UMoveNew.Shipments.TripEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../Content/new/form.css" rel="stylesheet" type="text/css" runat="server" />
</asp:Content>
            ...
            <div class="row">
                <div class="form-style-10">
                    ...
                    <div class="inner-wrap">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                        <asp:Label ID="Label7" runat="server" Text="CountryName" meta:resourcekey="Label7Resource1"></asp:Label></div>
                                   <div class="col-md-6">
                             <dx:ASPxComboBox ID="ASPxComboBox1"  Width="100%" runat="server" TextField="CountryName" ValueField="CountryName" DataSourceID="SqlDataSource1" Theme="Default" meta:resourcekey="ASPxComboBox1Resource1">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <asp:RadioButtonList ID="RadioButtonList2" CssClass="checkboxlist" runat="server" meta:resourcekey="RadioButtonList2Resource1">
                                            <asp:ListItem Value="1" meta:resourcekey="ListItemResource23" >Tow Away</asp:ListItem>
                                    ...
                                    <div class="col-md-6">
                                        <asp:RadioButtonList ID="RadioButtonList3" CssClass="checkboxlist" runat="server" meta:resourcekey="RadioButtonList3Resource1">
                                            <asp:ListItem Value="3" meta:resourcekey="ListItemResource25" >Open Transport</asp:ListItem>
