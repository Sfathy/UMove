<%@ Page Title="" Language="C#" MasterPageFile="~/Shipments/Site.Master" AutoEventWireup="true" CodeBehind="AllTrips.aspx.cs" Inherits="UMoveNew.Manger.AllTrips" %>
            ...
            <div class="row">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyFieldName="ID" Theme="Glass" DataSourceID="SqlDataSource1" Width="100%" EnableTheming="True" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" meta:resourcekey="ASPxGridView1Resource1">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewCommandColumn ButtonType="Image" Caption="Publish" VisibleIndex="11" meta:resourcekey="GridViewCommandColumnResource1">
                            <CustomButtons>
                                <dx:GridViewCommandColumnCustomButton ID="BtnPublish" Text="Publish" meta:resourcekey="GridViewCommandColumnCustomButtonResource1">
                        ...
                        <DetailRow>
                            <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" Theme="Glass" DataSourceID="SqlDataSource2" KeyFieldName="ID" OnBeforePerformDataSelect="detailGrid_BeforePerformDataSelect" Width="100%" meta:resourcekey="ASPxGridView2Resource1">
                                <Columns>
                                    ...
                                    <dx:GridViewDataCheckColumn FieldName="Puplished" Caption="Publish" VisibleIndex="8" ShowInCustomizationForm="True"></dx:GridViewDataCheckColumn>
