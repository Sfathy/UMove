...
{
    public partial class SharedQuestions : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            if (e.ButtonID == "btnAccept")
            {
                ...
                string sql = "Update SharedTripQuestions Set QuestionPuplished=1 Where QuestionID =" + id.ToString();
            ...
            if (e.ButtonID == "btnIgnore")
            {
                ...
                DataRow dr = ASPxGridView1.GetDataRow(Gid);
                int id = Convert.ToInt32(dr["QuestionID"].ToString());
                string sql = "Update SharedTripQuestions Set QuestionPuplished=3 Where QuestionID =" + id.ToString();
                DataAccess.ExecuteSQLNonQuery(sql);
