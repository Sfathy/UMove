...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Theme="PlasticBlue" Width="100%" KeyFieldName="QuestionID" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" EnableTheming="True" EnableCallBacks="False" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" meta:resourcekey="ASPxGridView1Resource1">
        <Columns>
            ...
            <dx:GridViewCommandColumn ButtonType="Image" Caption="Accept" VisibleIndex="7" meta:resourcekey="GridViewCommandColumnResource1">
                <CustomButtons>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT dbo.TripQuestions.Question, dbo.Users.Name AS QuestionUser, dbo.TripQuestions.Answer, Users_1.Name AS AnswerUser, dbo.TripQuestions.QuestionTime, dbo.TripQuestions.AnswerTime,dbo.TripQuestions.QuestionPuplished, dbo.TripQuestions.AnswerPuplished, dbo.Trip.Name FROM dbo.TripQuestions INNER JOIN dbo.Trip ON dbo.TripQuestions.TripID = dbo.Trip.ID LEFT OUTER JOIN dbo.Users AS Users_1 ON dbo.TripQuestions.AnswerUserID = Users_1.ID LEFT OUTER JOIN dbo.Users ON dbo.TripQuestions.QuestionUserID = dbo.Users.ID Where QuestionPuplished<>1"></asp:SqlDataSource>
                </div>
            </div>
          </div>
</asp:Content>
