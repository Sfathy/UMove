            ...
            <div class="row">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyFieldName="ID" Theme="Glass" DataSourceID="SqlDataSource1" Width="100%" EnableTheming="True" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" meta:resourcekey="ASPxGridView1Resource1">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataComboBoxColumn FieldName="ItemSubCatID" Caption=" Sub Catrgory" Width="100%" VisibleIndex="2" meta:resourcekey="GridViewDataComboBoxColumnResource2">
                        ...
                        <dx:GridViewCommandColumn ButtonType="Image" Caption="Bid" VisibleIndex="11" Width="100%" meta:resourcekey="GridViewCommandColumnResource1">
                            <CustomButtons>
                        ...
                        <dx:GridViewDataTextColumn Caption="Distance" FieldName="Dis" Name="Distance" Width="100%" UnboundType="Decimal" VisibleIndex="10" meta:resourcekey="GridViewDataTextColumnResource6">
                        ...
                        <DetailRow>
                            <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" Theme="Glass" DataSourceID="SqlDataSource2" KeyFieldName="ID" OnBeforePerformDataSelect="detailGrid_BeforePerformDataSelect" Width="100%" meta:resourcekey="ASPxGridView2Resource1">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="TripID" VisibleIndex="1" Width="100%" Visible="False" meta:resourcekey="GridViewDataTextColumnResource8" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="ItemDesc" Caption="Description" Width="100%" VisibleIndex="3" meta:resourcekey="GridViewDataTextColumnResource9" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Width" Caption="Width" VisibleIndex="4" Width="100%" meta:resourcekey="GridViewDataTextColumnResource10" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Height" Caption="Height" VisibleIndex="5" Width="100%" meta:resourcekey="GridViewDataTextColumnResource11" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Length" Caption="Length" VisibleIndex="6" Width="100%" meta:resourcekey="GridViewDataTextColumnResource12" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Wight" Caption="Wight" VisibleIndex="7" Width="100%" meta:resourcekey="GridViewDataTextColumnResource13" ShowInCustomizationForm="True"></dx:GridViewDataTextColumn>

                                    <dx:GridViewDataImageColumn FieldName="ImageURL" Caption="Image"  Width="100%" VisibleIndex="2" meta:resourcekey="GridViewDataImageColumnResource1" ShowInCustomizationForm="True"></dx:GridViewDataImageColumn>
